        ...
        <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="row js-list-filter" id="js-contacts">
                <?php foreach ($data as $item): ?>
                    <div class="col-xl-4">
                        <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $item['tags'] ?>">
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $item['avatar_filename'] ?>'); background-size: cover;"></span>
                                </span>
                                    <div class="info-card-text flex-1">
                                        ...
                                        <span class="text-truncate text-truncate-xl"><?php echo $item['role'] ?></span>
                                    </div>
                            ...
                            <div class="card-body p-0 collapse show">
                                <div class="p-3">
                                    <a href="tel:<?php echo $item['phone'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $item['phone_formatted'] ?></a>
