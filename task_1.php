...
function make_header_with_tag($data,$tag='h2') {
    return '<'.$tag.'>'.$data.'</'.$tag.'>';
}
?>
<!DOCTYPE html>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="fs-lg fw-300 p-5 bg-white border-faded rounded mb-g">
                                ...
                                <?php echo make_header_with_tag($block['header'],$block['header_tag']);?>
                                <p class="<?php echo $block['class']['p'];?>"><?php echo $block['text'];?></p>
                                <?php } ?>
                        </div>
                        </div>
                    </div>
